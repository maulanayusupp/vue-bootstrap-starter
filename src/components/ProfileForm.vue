			...
			<form @submit.prevent="save" class="pr-3">
				...
				<div class="row">
					<div class="col-md-6">
						...
						<!-- Phone -->
						<div class="form-group">
							<label>{{ $t('Phone') }} (<span class="text-small">{{ $t('Example: 9181234567890') }}</span>)</label>
							<!-- <div class="pos-r">
								<div class="absolute ml-3 pt-2 disabled" style="max-width: 20px">91</div>
...
export default {
	...
	methods: {
		...
		setData(data) {
			...
			this.phone = this.phone ? this.phone.replace('91', '') : null;
