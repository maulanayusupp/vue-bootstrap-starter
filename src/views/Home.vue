						...
						<div class="row">
							...
							<div class="col-4 text-end">
								<div class="icon icon-shape bg-gradient-primary shadow text-center border-radius-md">
									<i class="material-icons text-lg opacity-10 text-white">more_vert</i>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="card">
						...
						<div class="row">
							...
							<div class="d-flex flex-column h-100">
								<p class="mb-1 text-bold pt-2">Overview</p>
								<h5 class="font-weight-bolder">Report daily</h5>
								<p class="mb-5">From users, events, manage all things to complex elements, you will find the full documentation.</p>
							...
							<div class="col-lg-5 ms-auto text-center mt-5 mt-lg-0 ml-auto">
						...
						<div class="card-body p-3">
							...
							<div class="container border-radius-lg">
								...
								<div class="col-3 py-3 ps-0">
									...
									<div class="icon icon-shape icon-xxs shadow border-radius-sm bg-gradient-primary text-center mr-2 d-flex align-items-center justify-content-center">
								...
								<div class="col-3 py-3 ps-0">
									<div class="d-flex mb-2">
									<div class="icon icon-shape icon-xxs shadow border-radius-sm bg-gradient-info text-center mr-2 d-flex align-items-center justify-content-center">
								...
								<div class="col-3 py-3 ps-0">
									<div class="d-flex mb-2">
									<div class="icon icon-shape icon-xxs shadow border-radius-sm bg-gradient-warning text-center mr-2 d-flex align-items-center justify-content-center">
								...
								<div class="col-3 py-3 ps-0">
									<div class="d-flex mb-2">
									<div class="icon icon-shape icon-xxs shadow border-radius-sm bg-gradient-danger text-center mr-2 d-flex align-items-center justify-content-center">
										<svg width="10px" height="10px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
export default {
	...
	methods: {
		...
		showModalSignUp() {
			this.isShowModalSignUp = true;
		},
		closeModalSignUp() {
			this.isShowModalSignUp = false;
		},
		checkFirstTimeLogin() {
			const KEY = `FIRST_TIME_LOGIN_${this.user.id}`;
			const firstTimeLogin = localStorage.getItem(KEY);
			console.log(KEY, firstTimeLogin);
		},
	},
	watch: {
		user() {
			if (this.user) this.checkFirstTimeLogin();
			else this.closeModalSignUp();
		},
	},
	computed: {
		...mapGetters({
