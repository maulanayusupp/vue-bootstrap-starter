	...
	<div class="page page-categories">
		<div class="container">
			<div class="d-flex justify-content-between">
				<div class="mb-4">
					<h2>{{ $t('Categories') }}</h2>
					<div>{{ $t('Manage all categories data') }}</div>
				</div>
			</div>
			<!-- Table Menu -->
				...
				<div class="col-md-6 mb-2">
					<div class="d-flex justify-content-start">
						...
						<md-menu md-align-trigger :md-offset-x="0">
							...
							<md-menu-content>
								<md-menu-item @click="isImportCategoryVisible = true"><span class="minw-87">{{ $t('Import Category') }}</span></md-menu-item>
								<md-menu-item @click="isExportCategoryVisible = true"><span class="minw-87">{{ $t('Export Category') }}</span></md-menu-item>
							</md-menu-content>
						</md-menu>
					</div>
				</div>
		...
		<div class="modals">
			...
			<modal
				...
				<div>
					<a href="./../../template-xlsx/Template_Categories.xlsx" download>{{ $t('Download') }} Excel Template - {{ $t('Categories') }}</a>
				</div>
				</template>
				<template slot="footer">
					<div class="w-100 flex-center">
